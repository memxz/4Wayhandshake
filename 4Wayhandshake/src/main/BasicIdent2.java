 ...
 * message1 with MIC encryption within joux 
 */
  
public class BasicIdent2 implements Ident {  
  
    private Element a,b,c,P,Ta,Tb,Tc,Ka,Kb,Kc,M,T1,T2,T3,T4,T5,T6,T7,T8,Y;  
    private Field G1, Zr;  
    ...
    */  
    ...
    public void message1() {  
        ...
        M = pairing.getG1().newElement().setFromHash("message1+AA+Anonce+sn".getBytes(), 0, 20)  
                .getImmutable();
    ...
    public void message2() {  
       ...
       // c = Zr.newRandomElement().getImmutable();// Generate secret element
        M = pairing.getG1().newElement().setFromHash("message2+SA+Snonce+sn".getBytes(), 0, 21)  
                .getImmutable();
    ...
    public void message3() {  
        ...
        //c = Zr.newRandomElement().getImmutable();// Generate secret element
        M = pairing.getG1().newElement().setFromHash("message3+AA+Anonce+sn+1".getBytes(), 0, 22)  
                .getImmutable();
    ...
    public void message4() {  
       ...
       // c = Zr.newRandomElement().getImmutable();// Generate secret element
        M = pairing.getG1().newElement().setFromHash("message4+sn+1".getBytes(), 0, 13)  
                .getImmutable();
